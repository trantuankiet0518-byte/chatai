...
import type { VanHanPredictionContent } from "@/lib/contracts/vanhan";
...
const predictionVi: VanHanPredictionContent = {
...
export const vanHanContent: VanHanContent = {
  ...
  prediction: predictionVi,
};

const predictionEn: VanHanPredictionContent = {
  title: "Tomorrow and next week forecast",
  subtitle: "Daily transit + monthly transit",
  lunarToday: "Day 21, month 2, year of Binh Ngo",
  tomorrow: {
    date: "22/02 Lunar calendar",
    label: "Tomorrow",
    cung: "Travel Palace (Ty)",
    stars: ["Vu Khuc", "Thien Phu", "Loc Ton", "Triet", "Dia Khong"],
    summary:
      "The Travel Palace is strong with the Vu Khuc-Thien Phu-Loc Ton cluster. It is favorable for outside activity, partner meetings, and financial transactions.",
    advice:
      "Triet and Dia Khong can still create small obstacles or last-minute plan changes. Wealth stars remain active, so the final outcome still leans favorable if you stay flexible.",
    tone: "positive",
  },
  weekSegments: [
    {
      period: "Early week - 23-24/02",
      days: [
        {
          date: "23/02",
          label: "Wednesday",
          cung: "Health Palace (Suu)",
          stars: ["Sun", "Moon", "Hoa Khoa"],
          summary: "A good day for recovery. Fatigue should ease and you can find a more sustainable rhythm.",
          advice: "Prioritize health and release accumulated stress.",
          tone: "positive",
        },
        {
          date: "24/02",
          label: "Thursday",
          cung: "Wealth Palace (Dan)",
          stars: ["Tham Lang", "Hoa Ky"],
          summary: "Hoa Ky enters the Wealth Palace, so spending and lending need extra caution.",
          advice: "Avoid loans or signing financial agreements today to reduce dispute risk.",
          tone: "caution",
        },
      ],
    },
    {
      period: "Midweek - 25-26/02",
      days: [
        {
          date: "25/02",
          label: "Friday",
          cung: "Children Palace",
          stars: [],
          summary: "Focus turns to close relationships with family and trusted friends.",
          advice: "A suitable day to listen carefully and reinforce personal bonds.",
          tone: "neutral",
        },
        {
          date: "26/02",
          label: "Saturday",
          cung: "Body Palace (Thin)",
          stars: ["Tu Vi", "Thien Tuong"],
          summary: "The transit moves into the Body Palace, bringing confidence, presence, and control in key situations.",
          advice: "A strong moment for personal decisions or work that requires firmness.",
          tone: "positive",
        },
      ],
    },
    {
      period: "Late week - 27-28/02",
      days: [
        {
          date: "27/02",
          label: "Sunday",
          cung: "Siblings Palace",
          stars: [],
          summary: "Help or useful advice may come from siblings, peers, or long-time friends.",
          advice: "A good day to widen or strengthen your support network.",
          tone: "neutral",
        },
        {
          date: "28/02",
          label: "Monday",
          cung: "Life Palace (Ngo)",
          stars: ["Luu Thai Tue", "Kinh Duong"],
          summary:
            "The transit returns to the Life Palace, bringing strong energy but also pressure. Irritability rises and challenges may demand decisive action.",
          advice:
            "Staying calm is the key. Avoid unnecessary conflict, especially with authority figures.",
          tone: "caution",
        },
      ],
    },
  ...
  weekSummary:
    "This week alternates between financial opportunity early on and stronger self-assertion through the middle and end of the week. Thai Tue at the Life Palace means every move should come from composure and self-discipline.",
  weekAdvice:
    "The 24th and 28th are the two main caution points. Prioritize emotional control and avoid rushed financial decisions.",
};

export function getVanHanContent(locale: "vi" | "en" = "vi"): VanHanContent {
  return {
    ...vanHanContent,
    prediction: locale === "en" ? predictionEn : predictionVi,
  };
}
