...
export const MAJOR_STAR_DESC: Record<string, string> = {
  "Tử Vi": "Tử Vi là đế tinh, đứng đầu 14 chính tinh. Chủ về quyền lực, tôn quý và khả năng lãnh đạo.",
  "Thiên Cơ": "Thiên Cơ là mưu thần, chủ về trí tuệ, sự khéo léo và biến hóa.",
  "Thái Dương": "Thái Dương là mặt trời, chủ về danh tiếng, sự nghiệp và ánh sáng.",
  "Vũ Khúc": "Vũ Khúc là tài tinh, chủ về tiền bạc, kinh doanh và sự quyết đoán.",
  "Thiên Đồng": "Thiên Đồng chủ về phúc thọ, sự hưởng thụ và tính cách hiền lành.",
  "Liêm Trinh": "Liêm Trinh là quan tinh, chủ về pháp luật, kỷ luật và sự nghiêm khắc.",
  "Thiên Phủ": "Thiên Phủ là lộc khố, chủ về sự giàu có, ổn định và lòng bao dung.",
  "Thái Âm": "Thái Âm là mặt trăng, chủ về tình cảm, gia đình và sự nhạy cảm.",
  "Tham Lang": "Tham Lang chủ về ham muốn, tài năng đa dạng và sự hấp dẫn.",
  "Cự Môn": "Cự Môn chủ về thị phi, tranh luận và khả năng ngôn ngữ.",
  "Thiên Tướng": "Thiên Tướng là ấn tinh, chủ về sự hỗ trợ, bảo vệ và tính nguyên tắc.",
  "Thiên Lương": "Thiên Lương chủ về đạo đức, y học và sự bảo hộ.",
  "Thất Sát": "Thất Sát là tướng quân, chủ về uy dũng, quyết đoán và sự thay đổi đột phá.",
  "Phá Quân": "Phá Quân chủ về sự phá vỡ, cải cách và tinh thần tiên phong.",
};
